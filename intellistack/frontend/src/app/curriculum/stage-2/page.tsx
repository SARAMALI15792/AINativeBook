  ...
  useEffect(() => {
    const loadStageData = async () => {
      try {
        ...
        if (!user) {
          router.push('/auth/login?redirect=/curriculum/stage-2');
          return;
        }
        ...
        // Fetch stage data
        const stageResponse = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/learning/stages/stage-2`, {
          headers: authHeaders,
          credentials: 'include',
        });
        if (!stageResponse.ok) {
        ...
        // Fetch content items for this stage
        const contentResponse = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/learning/stages/stage-2/content`, {
          headers: authHeaders,
          credentials: 'include',
        });
      ...
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center max-w-md mx-auto p-6">
          ...
          <button
            ...
            className="px-4 py-2 bg-accent-cyan text-bg-primary rounded hover:bg-opacity-90 transition-colors"
          >
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <button
                    ...
                    onClick={() => router.push(`/curriculum/stage-2/${item.slug}`)}
                  >
                    View content
