      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        ...
        <div className="text-center mb-12 space-y-4">
          <Link href="/" className="inline-flex items-center justify-center space-x-3 group mb-4">
            <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-accent-blue to-accent-violet flex items-center justify-center shadow-glow-cyan group-hover:shadow-glow-violet transition-all">
        ...
        {isSubmitting && (
          <div className="fixed inset-0 z-modal flex items-center justify-center bg-black/60 backdrop-blur-sm">
            <div className="glass backdrop-blur-md rounded-xl p-8 text-center space-y-4">
              <div className="w-16 h-16 mx-auto border-4 border-accent-blue border-t-transparent rounded-full animate-spin" />
        ...
        {/* Benefits Section */}
        <div className="max-w-4xl mx-auto mt-16 pt-16 border-t border-border-subtle">
          <h2 className="text-2xl font-bold text-text-primary text-center mb-8">
            Why personalize your experience?
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="glass backdrop-blur-md rounded-lg p-6 border border-border-subtle text-center space-y-3">
              <div className="w-12 h-12 mx-auto rounded-lg bg-gradient-to-br from-accent-blue to-accent-violet flex items-center justify-center">
