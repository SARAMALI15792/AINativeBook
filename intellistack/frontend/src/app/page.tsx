...
export default function HomePage() {
  ...
  return (
    <main id="main-content" className="relative">
      ...
      <section className="relative py-20 md:py-32">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-4xl md:text-5xl font-bold font-heading text-text-primary">
      ...
      <section className="relative py-20 md:py-32">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center space-y-8 surface rounded-2xl p-12 md:p-16">
            <h2 className="text-4xl md:text-5xl font-bold font-heading text-text-primary">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
              <a
                href={`${process.env.NEXT_PUBLIC_DOCUSAURUS_URL || 'http://localhost:3005/AINativeBook'}/stage-1/intro`}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block px-8 py-4 bg-gradient-to-r from-accent-blue to-accent-violet rounded-lg text-white font-semibold text-lg hover:shadow-glow-blue transition-all duration-normal focus:outline-none focus:ring-2 focus:ring-accent-blue"
              >
                Start Learning Free
              </a>
              <a
                href="/curriculum"
                className="inline-block px-8 py-4 surface rounded-lg text-text-primary font-semibold text-lg border border-border-emphasis hover:border-accent-blue hover:text-accent-blue transition-all duration-normal focus:outline-none focus:ring-2 focus:ring-accent-blue"
              >
                Explore Curriculum
              </a>
            </div>
