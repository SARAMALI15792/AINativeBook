  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="flex items-center space-x-3 p-2 rounded-lg hover:bg-bg-elevated transition-colors focus:outline-none focus:ring-2 focus:ring-accent-cyan"
          ...
          <div className="absolute right-0 mt-2 w-64 glass backdrop-blur-md rounded-lg border border-border-subtle shadow-xl z-dropdown animate-fade-in-up">
            ...
            <div className="p-2">
              <button
                ...
                className="w-full flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-bg-elevated transition-colors text-left"
              >
