...
export function PersonalizationWizard({ onComplete, onSkip, className = '' }: PersonalizationWizardProps) {
  ...
  return (
    <div className={`max-w-2xl mx-auto ${className}`} role="region" aria-label="Personalization wizard">
      {/* Progress Bar */}
      <div className="mb-5 space-y-3" role="progressbar" aria-valuenow={currentStep} aria-valuemin={1} aria-valuemax={totalSteps} aria-label={`Step ${currentStep} of ${totalSteps}: ${currentStepData.title}`}>
      ...
      <div className="glass backdrop-blur-md rounded-2xl border-2 border-glass-border shadow-2xl overflow-hidden">
        {/* Step Content Card */}
        <div className="p-6 min-h-[300px] max-h-[50vh] overflow-y-auto animate-fade-in">
          {currentStepData.component}
        </div>

        {/* Navigation Footer Box */}
        <div className="glass backdrop-blur-md border-t-2 border-glass-border p-4">
