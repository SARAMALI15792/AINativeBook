...
function ChatKitWidgetContent(): JSX.Element | null {
  ...
  useEffect(() => {
    ...
    // Poll every 60 seconds as fallback (reduced from 3s to avoid excessive auth requests)
    // Primary trigger is the 'auth-state-changed' event dispatched by login/logout
